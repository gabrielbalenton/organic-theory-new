      ...
      <div className="w-full overflow-x-hidden">
        <section className="min-h-[85vh] flex flex-col justify-center px-6 md:px-12 max-w-7xl mx-auto py-20">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            {/* Visual Column - The 3:10 deploy had the rotation active */}
            <div className="order-1 lg:order-2 flex justify-center items-center relative">
              <motion.div
                animate={{ rotate: 360 }}
                transition={{ duration: 60, repeat: Infinity, ease: "linear" }}
                className="w-48 h-48 md:w-64 md:h-64 text-[#FAFAFA] opacity-20"
              >
          ...
          <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 lg:gap-32">
            ...
            <div className="grid grid-cols-2 gap-4 md:gap-8">
              {homeData.methodology.pillars.map((pillar) => (
                <div key={pillar.id} className="border border-[#FAFAFA]/10 p-6 md:p-8 flex flex-col justify-between aspect-square bg-[#FAFAFA]/5">
