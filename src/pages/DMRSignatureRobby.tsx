...
export default function DMRSignatureRobby() {
...
<table role="presentation" cellpadding="0" cellspacing="0" border="0" width="700"
  ...
  <tr>
    <td colspan="3" width="700" height="250" valign="top"
      background="${asset('FULLBG3.png')}"
      style="width:700px;height:250px;padding:0;margin:0;line-height:0;font-size:0;background-color:#061311;background-image:url('${asset('FULLBG3.png')}');background-repeat:no-repeat;background-position:left top;background-size:700px 250px;-webkit-background-size:700px 250px;">
      ...
      <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="700" height="250"
        ...
        <tr>
                ...
                <td valign="top" style="padding:0 0 0 8px;background:transparent;">
                  ...
                  <table role="presentation" cellpadding="0" cellspacing="0" border="0"
                    ...
                    <tr>
                      ...
                      <td valign="middle" style="padding:0 0 6px;white-space:nowrap;">
                        <a href="mailto:projects@dmrdesigns.com.au"
          ...
          <!-- ROBBY IS ALREADY BAKED INTO FULLBG.PNG -->
