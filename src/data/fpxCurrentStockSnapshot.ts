...
export const CURRENT_STOCK_CANDIDATES: Candidate[] = [
  ...
  candidate({
    slot: 'green',
    name: '100x50 (90x45) SG12 H3.2 Kiln Dried Machine Gauged (5.400m)',
    stockLineId: 'recJPPWmBLke0C6Kh',
    productId: 'rec0sATKosy93U4kV',
    discountPct: 24.663677130044842,
    moq: 1,
    available: 1,
    ...
    source: 'Packet Deals',
    characteristics: { nominalSizes: ['100x50'], gaugedSize: '90x45', grade: 'SG12', treatment: 'H3.2', condition: 'Kiln Dried', profile: 'Machine Gauged' },
  }),
  candidate({
    slot: 'green',
